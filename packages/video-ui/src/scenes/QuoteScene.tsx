...
export function QuoteScene({ scene }: SceneProps<Spec>): ReactElement {
  ...
  return (
    <SceneFrame testId="quote" backgroundAssetId={scene.background_asset_id} background="ink" typeWidth={Math.max(quote.fit.widthPx, attribution.fit.widthPx, source.fit.widthPx)}>
